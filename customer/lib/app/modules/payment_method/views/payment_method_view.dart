              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.inter(
                    color: isDark ? AppThemData.white : AppThemData.black,
                    fontSize: 16,
                      ...
                      () => Column(
                        ...
                        children: [
                          _methodTile(
                            ...
                            name: Constant.paymentModel!.strip?.name ?? "Stripe",
                            leading: Image.asset("assets/images/ig_stripe.png", height: 24, width: 24),
                            onChanged: () {
                          ...
                          _methodTile(
                            ...
                            name: Constant.paymentModel!.cash?.name ?? "Cash Direct",
                            leading: SvgPicture.asset("assets/icon/ic_cash.svg", width: 24, color: isDark ? AppThemData.white : AppThemData.black),
                            onChanged: () {
                          ...
                          _methodTile(
                            ...
                            name: Constant.paymentModel!.paypal?.name ?? "Paypal",
                            leading: Image.asset("assets/images/ig_paypal.png", height: 24, width: 24),
                            onChanged: () {
                          ...
                          _methodTile(
                            ...
                            name: Constant.paymentModel!.razorpay?.name ?? "Razorpay",
                            leading: Image.asset("assets/images/ig_razorpay.png", height: 24, width: 24),
                            onChanged: () {
                          ...
                          _methodTile(
                            ...
                            name: Constant.paymentModel!.payFast?.name ?? "PayFast",
                            leading: Image.asset("assets/images/ig_payfast.png", height: 24, width: 24),
                            onChanged: () {
