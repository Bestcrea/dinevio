                ...
                children: [
                  Expanded(
                    child: PageView(
                      ...
                      children: [
                        IntroScreenPage(
                          title: "Welcome to Dinevio".tr,
                          body: "Your reliable partner for delicious food delivery. Experience hassle-free dining at your fingertips.".tr,
                          image: "assets/icon/intro_image_one.svg",
                        ),
                        IntroScreenPage(
                          title: " Fast and Reliable".tr,
                          body: "Dinevio ensures prompt and reliable food delivery, getting your favorite meals to your doorstep with speed and efficiency.".tr,
                          image: "assets/icon/intro_image_two.svg",
                        ),
                        IntroScreenPage(
                          title: "Seamless User Experience".tr,
                          body: "Enjoy a user-friendly interface, easy ordering, and secure payments with Dinevio. Your meal, your way.".tr,
