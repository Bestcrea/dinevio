const Map<String, String> lnAr = {
  ...
  "Book Now": "احجز الآن",
  "Skip": "تخطي",
  "Welcome to Dinevio": "مرحباً بك في Dinevio",
  "Your reliable partner for delicious food delivery. Experience hassle-free dining at your fingertips.":
      "شريكك الموثوق به لتوصيل الطعام اللذيذ. استمتع بتجربة طعام خالية من المتاعب بنقرة واحدة.",
  ...
  "Dinevio ensures prompt and reliable food delivery, getting your favorite meals to your doorstep with speed and efficiency.":
      "تضمن Dinevio توصيل طعام سريع وموثوق، وتوصيل وجباتك المفضلة إلى باب منزلك بسرعة وكفاءة.",
  ...
  "Enjoy a user-friendly interface, easy ordering, and secure payments with Dinevio. Your meal, your way.":
      "استمتع بواجهة سهلة الاستخدام وطلبات سهلة ومدفوعات آمنة مع Dinevio. وجبتك، بطريقتك.",
  "Get Started": "ابدأ",
  "Language": "اللغة",
  "Login": "تسجيل الدخول",
  ...
  "Your ride history is currently empty. Start your journey with Dinevio by booking your first ride now!":
      "سجل رحلتك فارغ حاليًا. ابدأ رحلتك مع Dinevio بحجز رحلتك الأولى الآن!",
