...
/// Model for grocery order item
/// Path: grocery_orders/{orderId}/items/{itemId}
class GroceryOrderItemModel {
  ...
  factory GroceryOrderItemModel.fromDoc(DocumentSnapshot doc) {
    final data = doc.data() as Map<String, dynamic>;
    return GroceryOrderItemModel(
      id: doc.id,
...
/// Model for grocery order
/// Path: grocery_orders/{orderId}
class GroceryOrderModel {
  ...
  factory GroceryOrderModel.fromDoc(DocumentSnapshot doc) {
    final data = doc.data() as Map<String, dynamic>;
